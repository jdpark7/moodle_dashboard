<?php $__env->startSection('title', '학사 대시보드 로그인'); ?>
...
<div class="max-w-md mx-auto my-12 fade-in">
    <div class="glass p-8 rounded-3xl border border-slate-800/80 shadow-2xl relative overflow-hidden">
        ...
        <form method="POST" action="<?php echo e(route('login.post')); ?>" id="login-form" class="space-y-5 relative z-10" onsubmit="showLoading('로그인 확인 중...')">
            <?php echo csrf_field(); ?>
        ...
        <div class="mt-4 mb-2 text-center relative z-10">
            <a href="<?php echo e(route('register')); ?>" class="text-xs text-brand-400 hover:text-brand-300 font-semibold transition-colors">
                아직 계정이 없으신가요? 회원가입하기
            </a>
        </div>
...
<?php echo $__env->make('moodledash::layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\moodledashboard-laravel\Modules/MoodleDash/resources/views/login.blade.php ENDPATH**/ ?>