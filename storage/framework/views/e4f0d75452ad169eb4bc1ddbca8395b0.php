...
<div class="max-w-xl mx-auto my-6 fade-in">
    <div class="glass p-8 rounded-3xl border border-slate-800/80 shadow-2xl relative overflow-hidden">
        ...
        <form method="POST" action="<?php echo e(route('register.post')); ?>" id="register-form" class="space-y-4 relative z-10" onsubmit="showLoading('회원등록 진행 중...')">
            <?php echo csrf_field(); ?>
            ...
            <div class="space-y-1">
                ...
                <input type="text" name="username" id="username" required value="<?php echo e(old('username')); ?>"
            ...
            <div class="grid grid-cols-2 gap-3">
                <div class="space-y-1">
                    ...
                    <input type="text" name="lastname" id="lastname" required value="<?php echo e(old('lastname')); ?>"
                           class="w-full bg-slate-950/40 border border-slate-800 focus:border-brand-500 rounded-xl py-2.5 px-4 text-sm text-slate-100 focus:outline-none transition-colors"
                           placeholder="예: 김">
                </div>
                <div class="space-y-1">
                    <label for="firstname" class="text-xs font-semibold text-slate-400 uppercase tracking-wider">이름 (First Name)</label>
                    <input type="text" name="firstname" id="firstname" required value="<?php echo e(old('firstname')); ?>"
                           class="w-full bg-slate-950/40 border border-slate-800 focus:border-brand-500 rounded-xl py-2.5 px-4 text-sm text-slate-100 focus:outline-none transition-colors"
                           placeholder="예: 민수">
                </div>
            </div>
        ...
        <div class="mt-4 text-center">
            <a href="<?php echo e(route('login')); ?>" class="text-xs text-slate-400 hover:text-slate-200 transition-colors">
...
<?php echo $__env->make('moodledash::layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\moodledashboard-laravel\Modules/MoodleDash/resources/views/register.blade.php ENDPATH**/ ?>