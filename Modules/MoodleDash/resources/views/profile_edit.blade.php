        ...
        <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="space-y-5 relative z-10" onsubmit="showLoading('정보 수정 반영 중...')">
            ...
            <div class="space-y-3">
                ...
                <div class="flex items-center gap-4">
                    <img src="{{ $user->userpictureurl }}" id="current-avatar-preview" alt="Current Avatar" class="w-14 h-14 rounded-xl object-cover ring-2 ring-indigo-500/25 bg-slate-900">
