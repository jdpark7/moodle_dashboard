...
@section('title', 'LMS Dashboard Login')
...
<div class="max-w-md mx-auto my-12 fade-in">
    <div class="glass p-8 rounded-3xl border border-slate-800/80 shadow-2xl relative overflow-hidden">
        ...
        <div class="text-center mb-8 relative z-10">
            ...
            <h1 class="text-2xl font-bold text-white tracking-tight">LMS Dashboard Portal</h1>
            <p class="text-slate-400 text-sm mt-2">Log in with your credentials</p>
        </div>

        <!-- Form for Login Connection -->
        <form method="POST" action="{{ route('login.post') }}" id="login-form" class="space-y-5 relative z-10" onsubmit="showLoading('Verifying credentials...')">
            @csrf
        ...
        <div class="relative my-8 text-center relative z-10">
            ...
            <span class="relative bg-[#0d1322] px-3 text-xs font-semibold text-slate-500 uppercase tracking-wider z-10">Quick Test Accounts</span>
        </div>
        ...
        <div class="grid grid-cols-2 gap-3 relative z-10">
            ...
            <button type="button" onclick="quickLogin('student_hong', 'password')"
                ...
                <div>
                    <h3 class="text-sm font-bold text-slate-200">Student (Hong G.D.)</h3>
            ...
            <button type="button" onclick="quickLogin('prof_kim', 'password')"
                ...
                <div>
                    <h3 class="text-sm font-bold text-slate-200">Teacher (Kim M.S.)</h3>
        ...
        <div class="mt-6 border-t border-slate-850 pt-4 relative z-10 text-[11px] text-slate-500 flex items-center justify-between">
            ...
            <span class="text-slate-600 font-mono text-[9px]">schema v1.0</span>
        </div>
    </div>
</div>
@endsection
...
<script>
    function quickLogin(username, password) {
        ...
        showLoading("Processing quick login...");
