        ...
        <aside class="w-72 glass border-r border-slate-800/80 hidden md:flex flex-col shrink-0">
            ...
            <div class="p-4 border-t border-slate-800/50">
                <div class="flex items-center gap-3 p-2 rounded-xl bg-slate-900/30 border border-slate-800/30">
                    <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 flex-1 min-w-0 group">
                        <img src="{{ session('userpictureurl') }}" alt="Profile" class="w-10 h-10 rounded-lg object-cover ring-2 ring-indigo-500/30 group-hover:ring-brand-500/50 transition-all bg-slate-800">
